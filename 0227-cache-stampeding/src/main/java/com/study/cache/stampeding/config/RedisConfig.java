package com.study.cache.stampeding.config;
...
public class RedisConfig {
	...
	@Bean
	public LettuceConnectionFactory bakRedisConnectionFactory(RedisStandaloneConfiguration bakRedisConfig) {
		return new LettuceConnectionFactory(bakRedisConfig);
	}

	@Bean
	public RedisTemplate<String, String> bakRedisTemplate(LettuceConnectionFactory bakRedisConnectionFactory) {
		StringRedisTemplate redisTemplate = new StringRedisTemplate();
		redisTemplate.setConnectionFactory(bakRedisConnectionFactory);
		return redisTemplate;
	}
}
